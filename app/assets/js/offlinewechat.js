jQuery(document).ready(function() {
    ...
    console.log("Offline WeChat Deposit Loaded");
    ...
    jQuery('#sendrequest').click(function() {
        ...
        var dAccountNumber = String(jQuery('#AccountNumber').val());
        ...
        var endpoint = 'api/PaymentGateway/WeChatOfflineDeposit';
        ...
        if (intendedLoop > 0) {
            for (var itr = 0; itr < intendedLoop; itr++) {
                ...
                var raw = dAmount + dOrderDate + dOrderNumber + AccountNumber + dCallbackUrl + dNotes;
                ...
                jQuery.ajax({
                    ...
                    success: function(result) {
                        ...
                        jQuery.each(result.Data, function() {
                            jQuery('#qrcodeimage').attr('href', result.Data.QrCodeImageUrl);
                            jQuery('#qrcodeimage').text(result.Data.QrCodeImageUrl);
