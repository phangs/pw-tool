jQuery(document).ready(function() {
    ...
    console.log("Offline WeChat Withdrawal Loaded");
    ...
    jQuery('#sendrequest').click(function() {
        ...
        var endpoint = 'api/PaymentGateway/WeChatOfflineWithdrawal';
        ...
        if (intendedLoop > 0) {
            for (var itr = 0; itr < intendedLoop; itr++) {
                ...
                var raw = dAmount + dOrderDate + dOrderNumber + dCurrency + dAccountNumber + dCallbackUrl + dNotes;
