jQuery(document).ready(function() {
    ...
    console.log("Online Withdrawal Loaded");
    ...
    jQuery('#sendrequest').click(function() {
        ...
        var endpoint = 'api/PaymentGateway/OnlineWithdrawal';
        ...
        if (intendedLoop > 0) {
            for (var itr = 0; itr < intendedLoop; itr++) {
                ...
                var raw = dAmount + dOrderDate + dOrderNumber + dBankCode + dBankAccountName + dBankAccountNo + dCurrency + dCallbackUrl + dNotes;
