jQuery(document).ready(function() {
    ...
    console.log("Upload Deposit Slip V2 Loaded");
    ...
    jQuery('#sendrequest').click(function() {
        ...
        var dReferenceBankAccountNumber = String(jQuery('#ReferenceBankAccountNumber').val());
        var dReferenceBankAccountName = String(jQuery('#ReferenceBankAccountName').val());
        var dReferenceTransactionNumber = String(jQuery('#ReferenceTransactionNumber').val());
        var dReferenceDepositAmount = String(jQuery('#ReferenceDepositAmount').val());
        var dReferenceDepositSlipImageURL = String(jQuery('#ReferenceDepositSlipImageURL').val());
        ...
        if (intendedLoop > 0) {
            for (var itr = 0; itr < intendedLoop; itr++) {
                ...
                var raw = dTransactionNumber + dReferenceBankAccountNumber + dReferenceBankAccountName + dReferenceTransactionNumber + dReferenceDepositAmount + dReferenceDepositSlipImageURL + dFileNameWithExtension;
                ...
                var dataObj = {
                    ...
                    'ReferenceBankAccountNumber': dReferenceBankAccountNumber,
                    'ReferenceBankAccountName': dReferenceBankAccountName,
                    'ReferenceTransactionNumber': dReferenceTransactionNumber,
                    'ReferenceDepositAmount': dReferenceDepositAmount,
                    'ReferenceDepositSlipImageURL': dReferenceDepositSlipImageURL,
