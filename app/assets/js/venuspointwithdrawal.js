jQuery(document).ready(function() {
    ...
    console.log("Online Venus Point Withdrawal Loaded");
    ...
    jQuery('#sendrequest').click(function() {
        ...
        // var dUserPassword = String(jQuery('#UserPassword').val());
        ...
        var endpoint = 'api/PaymentGateway/VenusPointWithdrawal';
        ...
        if (intendedLoop > 0) {
            for (var itr = 0; itr < intendedLoop; itr++) {
                ...
                var raw = dAmount + dOrderDate + dOrderNumber + dUserId  + dCallbackUrl + dNotes;
